...
engine = create_engine('sqlite:///restaurantwithusers.db')
...
FoodItem8 = FoodItem(user_id=1, name="Veggie Burger", description="Made with freshest of ingredients and home grown spices",
                     price="$5.99", course="Entree", restaurant=restaurant1)

session.add(FoodItem8)
session.commit()
